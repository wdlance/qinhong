<template>
  <div id="articles" v-loading="loading">
    <div class="search">
      <el-button-group>
        <el-button type="primary" icon="el-icon-plus" :size="inputSize" @click="handleTabsCreate()" plain></el-button>
        <el-button type="primary" icon="el-icon-download" :size="inputSize" plain></el-button>
        <el-button type="primary" icon="el-icon-delete" :size="inputSize" @click="batchDelete()" plain></el-button>
        <el-button type="primary" icon="el-icon-refresh" :size="inputSize" @click="handlePage(1)" plain></el-button>
      </el-button-group>
